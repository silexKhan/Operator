...
class CircuitManager:
    ...
    def create_new_circuit(self, name: str) -> bool:
        ...
        target_dir = os.path.join(get_project_root(), "circuits", "registry", name_lower)
        ...
        try:
            ...
            with open(os.path.join(target_dir, "actions.py"), "w", encoding="utf-8") as f:
                f.write(f"from circuits.base import BaseCircuit\n\nclass {name.capitalize()}Circuit(BaseCircuit):\n    def get_name(self) -> str:\n        return \"{name_lower}\"\n")
    ...
    def create_new_unit(self, name: str) -> bool:
        ...
        name_lower = name.lower().strip()
        target_dir = os.path.join(get_project_root(), "units", name_lower)
        if os.path.exists(target_dir):
            return False
    ...
    def _load_unit_spec_text(self, root: str, unit: str) -> str:
        ...
        json_path = os.path.join(root, "units", unit, "protocols.json")
