#
#  overview.py - MCP Operator Core Identity (Dynamic Path Edition) 🛡️⚡️
#
...
class Overview:
    ...
    DESCRIPTION = (
        ...
        "물리적으로 통제하고 품질을 보증하는 지능형 엔진입니다. 🛡️✨"
    )

    # [대장님 🎯] 배속된 전문 기술 유닛(Unit) 리스트입니다. 🐍
    UNITS = ["python", "markdown"]

    # [대장님 🎯] 하드코딩 완전 박멸! 현재 위치를 기준으로 프로젝트 루트를 자동 감지합니다. 🕵️‍♂️🚀
