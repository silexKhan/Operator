#
#  operator_protocols.py - The Master Constitution for Operator (교환) ⚖️
...
class OperatorProtocols(GlobalProtocols):
    ...
    모든 테넌트와 프로젝트는 이 프로토콜을 근간으로 삼아야 합니다. 🛡️
    """
    
    OPERATOR_RULES = [
        "Protocol 1-1 (The Master): 모든 작업의 최종 결정권자는 '대장님'이며, 의도가 불분명할 경우 반드시 확인 절차를 거친다.",
